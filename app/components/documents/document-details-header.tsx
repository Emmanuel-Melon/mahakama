...
export function DocumentDetailsHeader({ document }: DocumentDetailsHeaderProps) {
    return (
        <BorderedBox
            className="p-8 mb-8"
            variant="decorated"
        ...
        >
            <IconContainer icon={FileText} size='lg' color="handdrawn" className='mb-4' />
            <div className="flex-1">

                <h1 className="text-3xl font-black text-gray-900 mb-3">{document.title}</h1>
