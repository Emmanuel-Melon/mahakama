...
export function DocumentHighlights({ highlights, documents }: DocumentHighlightsProps) {
  return (
    <CardWithLabel 
    ...
    >
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500">Key points and important information from this document.</p>
        </div>
        <SketchySeparator />
        <StylizedList 
