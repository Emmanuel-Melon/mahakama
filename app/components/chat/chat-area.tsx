          ...
          >
            ...
            >
              <div className="space-y-2 break-words">
                ...
                {message.sender?.type === "assistant" && relevantLaws?.length > 0 && (
                  <div className="mt-2">
                    <div className="text-xs font-semibold text-gray-500 mb-1">Relevant Laws:</div>
                ...
                {message.sender?.type === "assistant" && relatedDocuments?.length > 0 && (
                  <div className="mt-2">
                    <div className="text-xs font-semibold text-gray-500 mb-1">Related Documents:</div>
                    <div className="space-y-2">
                      {relatedDocuments.map((doc) => (
                        ...
                        >
                          ...
                          <div className="text-blue-600">{doc.description}</div>
                        </a>
                      ))}
                    </div>
                  </div>
