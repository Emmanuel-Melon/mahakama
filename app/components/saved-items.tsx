import { User, FileText, MoreVertical, Share, Trash2, type LucideIcon } from "lucide-react";
            ...
            >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {renderContent(item)}
                  <p className="text-xs text-gray-400 mt-1">Saved {item.savedDate}</p>
                </div>
              ...
              {/* Dropdown Menu */}
              {showDropdown === index && (
                <div className="absolute right-2 top-12 bg-white border-2 border-gray-900 rounded-lg shadow-lg z-10"
                  style={{
                    boxShadow: "2px 2px 0 0 #000",
                  }}
                >
