...
const features = [
  ...
  },
  {
    ...
    title: "Legal Library",
    description:
      "Access a comprehensive library of legal documents, forms, and resources at your fingertips.",
    href: "/documents",
  },
  {
    id: "connect-experts",
    ...
    description:
      "Get personalized guidance from vetted legal professionals when you need it most.",
    href: "/lawyers",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-lg text-gray-600">
            Access the legal resources and support you need, whether you're
            facing a legal issue or just need information. Our platform makes
            the law accessible to everyone.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {features.map((feature) => (
            <CardWithLabel
              ...
              key={feature.id}
              className={cn(
                "border-solid group transition-all duration-200 transform hover:-translate-y-1 hover:shadow-[6px_6px_0_0_rgba(0,0,0,1)]",
                "flex gap-4 h-full",
              )}
            >
