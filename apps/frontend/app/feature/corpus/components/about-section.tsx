  ...
  return (
    <div className="mt-12 p-6 border-2 border-gray-900 rounded-lg relative bg-white">
      ...
      <p className="text-gray-800 mb-5 leading-relaxed">
        Our legal database is continuously updated to reflect the most current
        laws and regulations. Each document is carefully curated and includes:
      </p>
      ...
      <div className="p-4 border-2 border-dashed border-gray-300 rounded relative">
        ...
        <p className="text-sm text-gray-800">
          While we strive for accuracy, this information is for general guidance
          only. For legal advice specific to your situation, please consult a
