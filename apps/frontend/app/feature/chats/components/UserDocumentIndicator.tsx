...
import { useDeleteUserDocument } from "@mah/api/hooks/use-user-documents";
import { Button } from "~/components/ui/button";

interface UserDocumentIndicatorProps {
  filename?: string;
  totalChunks?: number;
  sessionId: string;
}

export function UserDocumentIndicator({
  filename,
  totalChunks,
  sessionId,
}: UserDocumentIndicatorProps) {
