    ...
    <div className="container mx-auto p-6 space-y-12">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground max-w-2xl">
          Whether you are a legal professional managing cases or a user seeking justice across East Africa, our regional teams are ready to assist.
        </p>
      </div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input className="w-full p-3 border-2 border-black rounded focus:ring-2 focus:ring-yellow-400 outline-none" placeholder="Emmanuel" />
                </div>
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-wider">Last Name</label>
                  <input className="w-full p-3 border-2 border-black rounded focus:ring-2 focus:ring-yellow-400 outline-none" placeholder="Gatwech" />
                </div>
              </div>

              <div className="space-y-1">
                <label className="text-xs font-bold uppercase tracking-wider">Email Address</label>
                <input type="email" className="w-full p-3 border-2 border-black rounded focus:ring-2 focus:ring-yellow-400 outline-none" placeholder="emmanuel@mahakama.com" />
              </div>

              <div className="space-y-1">
                <label className="text-xs font-bold uppercase tracking-wider">Regional Subject</label>
              ...
              <div className="space-y-1">
                ...
                <textarea rows={4} className="w-full p-3 border-2 border-black rounded focus:ring-2 focus:ring-yellow-400 outline-none" placeholder="Tell us how we can help..."></textarea>
              </div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">South Sudan, Kenya, Uganda, Rwanda, Tanzania</p>
                </div>
              </div>
              <div className="flex gap-3">
          ...
          <CardWithLabel label="Response Time" className="bg-zinc-50">
            <p className="text-sm italic">
              "We aim to respond to all inquiries within 24 hours during standard East Africa Time (EAT) business hours."
            </p>
          </CardWithLabel>
        </div>
      </div>
