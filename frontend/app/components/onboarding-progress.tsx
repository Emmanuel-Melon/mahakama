...
export function OnboardingProgress({ className = "" }: OnboardingProgressProps) {
  ...
  return (
    <div className={`bg-white border-2 border-gray-900 rounded-lg shadow-[2px_2px_0_0_#000] ${className}`}>
      <div className="p-4">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-sm font-semibold text-gray-900">Complete Your Profile</h3>
          <div className="flex items-center gap-2">
            <span className="text-xs text-gray-600">{completedSteps}/{totalSteps}</span>
            <button
